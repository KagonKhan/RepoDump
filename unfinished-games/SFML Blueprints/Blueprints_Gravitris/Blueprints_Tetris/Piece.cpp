...
b2Fixture* Piece::createPart(int pos_x, int pos_y, TetriminoTypes type)
{
    ...
    b2shape.SetAsBox(converter::pixelsToMeters<double>(BOX_SIZE_2), converter::pixelsToMeters<double>(BOX_SIZE_2)
        , b2Vec2(converter::pixelsToMeters<double>(BOX_SIZE_2 + (pos_x * BOX_SIZE)), converter::pixelsToMeters<double>(BOX_SIZE_2 + (pos_y * BOX_SIZE))), 0);
